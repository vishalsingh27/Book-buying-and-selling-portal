...
<div id="parent_toggle">
	<div class="toggle">
		<table id="table">
			...
			<tr><td><a href="requestbook.php">>Bookistan Wallet</td></a></tr>
			<tr><td><a href="requestbook.php">>Loyality Points</td></a></tr>
			<tr><td><a href="requestbookphp">>Friends Refered</td></a></tr>
		</table>
	</div>
	...
	<div id="main">
		...
		<form>
			<table>
				...
				<tr>
					<td colspan="8" width="80px"><input type="text" name="name" size="50" style="width: 400px;height: 20px"></td>
					<td colspan="8"><input type="date" name="date" style="width: 400px;height: 20px"></td>
				</tr>
				<tr><td colspan="8" width="50px">Gender</td>
					<td colspan="8" width="50px">Email</td>
				</tr>
				<tr>
					<td colspan="8" width="80px"><select style="width: 400px;height: 20px">
						<option>Male</option>
						<option>Female</option>
						<option>Transgender</option>
					</select></td>
					<td colspan="8"><input type="Email" name="date" style="width: 400px;height: 20px"></td>
				</tr>
			</table><br>
	...
	<div id="pass">
			...
			<table>
				...
				<tr>
					<td colspan="8" width="80px"><input type="text" name="name" size="50" placeholder="Enter your Current password" style="width: 400px;height: 20px"></td>
				</tr>
				<tr><td colspan="8" width="50px">Password</td>
				</tr>
					<td colspan="8"><input type="Password" name="password" placeholder="Enter new password" style="width: 400px;height: 20px"></td>
				</tr>
				<tr><td colspan="8" width="50px">Confirm Password</td>
				</tr>
					<td colspan="8"><input type="Email" name="date" placeholder="Confirm new password" style="width: 400px;height: 20px"></td>
				</tr>
			</table><br>
			<button class="button" style="float: right"><span>SAVE </span></button>
